LIBNOISE.module.transformer.Turbulence = function(sourceModule, frequency, power, roughness, seed) {
	...
	this.power          = power         || LIBNOISE.module.transformer.Turbulence.DEFAULT_TURBULENCE_POWER;
	this.roughness      = roughness     || LIBNOISE.module.transformer.Turbulence.DEFAULT_TURBULENCE_ROUGHNESS;
	this.seed           = seed          || LIBNOISE.module.generator.Perlin.DEFAULT_PERLIN_SEED;

};

LIBNOISE.module.transformer.Turbulence.DEFAULT_TURBULENCE_POWER     = 1.0;
LIBNOISE.module.transformer.Turbulence.DEFAULT_TURBULENCE_ROUGHNESS = 3;

LIBNOISE.module.transformer.Turbulence.prototype = {
